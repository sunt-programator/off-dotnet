// <copyright file="ThreadSafeCacheFactoryTests.cs" company="Sunt Programator">
...
public class ThreadSafeCacheFactoryTests
{
    private readonly ThreadSafeCacheFactory<string, string> _cache = new(2048, 65536, 16);
