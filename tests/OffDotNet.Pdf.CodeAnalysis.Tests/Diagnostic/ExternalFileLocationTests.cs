...
public class ExternalFileLocationTests
{
    ...
    [Fact(DisplayName = $"The {nameof(Location.SourceSpan)} property must be assigned from constructor.")]
    ...
    [Fact(DisplayName = $"The {nameof(Location.LineSpan)} property must be assigned from constructor.")]
    ...
    [Fact(DisplayName = $"The GetHashCode() method must include the {nameof(Location.SourceSpan)} and {nameof(Location.LineSpan)} properties.")]
