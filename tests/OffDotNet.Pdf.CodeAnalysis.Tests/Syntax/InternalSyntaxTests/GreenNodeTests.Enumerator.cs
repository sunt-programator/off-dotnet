// <copyright file="GreenNodeTests.Enumerator.cs" company="Sunt Programator">
...
public class GreenNodeTestsEnumerator
{
    ...
    {
        // Arrange
        GreenNode.Enumerator enumerator = default;
    ...
    {
        // Arrange
        var enumerator = new GreenNode.Enumerator(GreenNode.None);
    ...
    [Fact(DisplayName =
        $"The {nameof(GreenNode.Enumerator.Current)} property must throw a {nameof(InvalidOperationException)} when the underlying node is a single node")]
