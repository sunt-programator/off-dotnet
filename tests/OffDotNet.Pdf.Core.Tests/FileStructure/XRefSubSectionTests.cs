...
[System.Diagnostics.CodeAnalysis.SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1402:File may only contain a single type", Justification = "TestData")]
internal static class XRefSubSectionTestsDataGenerator
{
    public static IEnumerable<object[]> XRefSubSection_Content_TestCases()
    {
        yield return new object[] { 0, new List<IXRefEntry> { new XRefEntry(0, 65535, XRefEntryType.Free) }, "0 1\n0000000000 65535 f \n" };
        yield return new object[] { 3, new List<IXRefEntry> { new XRefEntry(25325, 0, XRefEntryType.InUse) }, "3 1\n0000025325 00000 n \n" };
        yield return new object[]
            {
                23, new List<IXRefEntry> { new XRefEntry(25518, 2, XRefEntryType.InUse), new XRefEntry(25635, 0, XRefEntryType.InUse) }, "23 2\n0000025518 00002 n \n0000025635 00000 n \n",
            };
        yield return new object[] { 30, new List<IXRefEntry> { new XRefEntry(25777, 0, XRefEntryType.InUse) }, "30 1\n0000025777 00000 n \n" };
    }

    public static IEnumerable<object[]> XRefSubSection_ObjectNumber_TestCases()
    {
        yield return new object[] { 0, new List<IXRefEntry> { new XRefEntry(0, 65535, XRefEntryType.Free) }, 0 };
        yield return new object[] { 3, new List<IXRefEntry> { new XRefEntry(25325, 0, XRefEntryType.InUse) }, 3 };
        yield return new object[] { 23, new List<IXRefEntry> { new XRefEntry(25518, 2, XRefEntryType.InUse), new XRefEntry(25635, 0, XRefEntryType.InUse) }, 23 };
        yield return new object[] { 30, new List<IXRefEntry> { new XRefEntry(25777, 0, XRefEntryType.InUse) }, 30 };
    }

    public static IEnumerable<object[]> XRefSubSection_NumberOfEntries_TestCases()
    {
        yield return new object[] { 0, new List<IXRefEntry> { new XRefEntry(0, 65535, XRefEntryType.Free) }, 1 };
        yield return new object[] { 3, new List<IXRefEntry> { new XRefEntry(25325, 0, XRefEntryType.InUse) }, 1 };
        yield return new object[] { 23, new List<IXRefEntry> { new XRefEntry(25518, 2, XRefEntryType.InUse), new XRefEntry(25635, 0, XRefEntryType.InUse) }, 2 };
        yield return new object[] { 30, new List<IXRefEntry> { new XRefEntry(25777, 0, XRefEntryType.InUse) }, 1 };
    }

    public static IEnumerable<object[]> XRefSubSection_NoExpectedData_TestCases()
    {
        yield return new object[] { 0, new List<IXRefEntry> { new XRefEntry(0, 65535, XRefEntryType.Free) } };
        yield return new object[] { 3, new List<IXRefEntry> { new XRefEntry(25325, 0, XRefEntryType.InUse) } };
        yield return new object[] { 23, new List<IXRefEntry> { new XRefEntry(25518, 2, XRefEntryType.InUse), new XRefEntry(25635, 0, XRefEntryType.InUse) } };
        yield return new object[] { 30, new List<IXRefEntry> { new XRefEntry(25777, 0, XRefEntryType.InUse) } };
    }

    public static IEnumerable<object[]> XRefSubSection_Equals_TestCases()
    {
        yield return new object[] { 0, 0, new List<IXRefEntry> { new XRefEntry(0, 65535, XRefEntryType.Free) }, new List<IXRefEntry> { new XRefEntry(0, 65535, XRefEntryType.Free) }, true };
        yield return new object[] { 3, 1, new List<IXRefEntry> { new XRefEntry(25325, 0, XRefEntryType.InUse) }, new List<IXRefEntry> { new XRefEntry(25325, 0, XRefEntryType.InUse) }, false };
        yield return new object[]
        {
            23, 23, new List<IXRefEntry> { new XRefEntry(25518, 2, XRefEntryType.InUse), new XRefEntry(25635, 0, XRefEntryType.InUse) },
            new List<IXRefEntry> { new XRefEntry(25518, 2, XRefEntryType.InUse) }, false,
        };
        yield return new object[] { 30, 30, new List<IXRefEntry> { new XRefEntry(25777, 0, XRefEntryType.InUse) }, new List<IXRefEntry> { new XRefEntry(25777, 65535, XRefEntryType.InUse) }, false };
    }
    ...
    public static IEnumerable<object[]> XRefSubSection_Bytes_TestCases()
    {
        yield return new object[]
        {
            0, new List<IXRefEntry> { new XRefEntry(0, 65535, XRefEntryType.Free) },
        ...
        yield return new object[]
        {
            3, new List<IXRefEntry> { new XRefEntry(25325, 0, XRefEntryType.InUse) },
        ...
        yield return new object[]
        {
            23, new List<IXRefEntry> { new XRefEntry(25518, 2, XRefEntryType.InUse), new XRefEntry(25635, 0, XRefEntryType.InUse) },
            new byte[]
            {
        ...
        yield return new object[]
        {
            30, new List<IXRefEntry> { new XRefEntry(25777, 0, XRefEntryType.InUse) },
